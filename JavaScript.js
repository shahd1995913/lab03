...
if(answer == "python"){alert ("ok.")}

else if(answer == "java"){alert ("great we use java to build a websits.")}

else if(answer == "C#"){alert ("Sorry we do not support this languge")}
else if(answer == "C++"){alert ("ok.")}

else if(answer == "R"){alert ("greet this is the best program that support the mechine learning.")}
